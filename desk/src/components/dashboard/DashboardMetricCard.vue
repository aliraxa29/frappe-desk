    ...
    <div
        ...
        <div class="p-6">
            ...
            <div class="flex items-start justify-between mb-4">
                ...
                <!-- Icon -->
                <div v-if="icon" class="p-3 rounded-lg" :class="[
                    iconBackgroundClass,
                    'text-base'
                ]">
                    <Icon :icon="icon" />
            ...
            <div v-if="change !== undefined" class="flex items-center gap-2">
                <Icon :icon="change >= 0 ? 'lucide:trending-up' : 'lucide:trending-down'"
                    :class="change >= 0 ? 'text-green-600' : 'text-red-600'" />
                <span :class="change >= 0 ? 'text-green-600' : 'text-red-600'" class="font-medium text-sm">
                    {{ change >= 0 ? '+' : '' }}{{ change }}%
                </span>
            ...
            <div v-if="sparklineData" class="mt-4 h-12">
                <apexchart type="sparkline" :series="[{ data: sparklineData }]" :options="sparklineOptions"
                    height="48" />
            </div>
