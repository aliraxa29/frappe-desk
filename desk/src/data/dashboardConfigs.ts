...
import type { DashboardFilter, DashboardMetric } from '../components/dashboard/DashboardContainer.vue'
...
export const salesDashboardConfig = {
    ...
    description: 'Monitor sales performance and revenue metrics across all channels',
    metrics: [
        {
            label: 'Total Revenue',
            value: 125000,
