    ...
    <div class="flex flex-col min-h-full bg-gray-50 dark:bg-gray-900 ml-64">
        ...
        <header class="bg-white dark:bg-gray-950 border-b border-slate-200 dark:border-slate-800 px-6 py-4">
            <div class="flex items-center gap-3">
                <span v-if="moduleContent.icon" class="text-2xl">{{ getIcon(moduleContent.icon) }}</span>
                <div>
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <span v-if="dt.description" class="text-xs text-slate-500 dark:text-slate-400 truncate block mt-1">
                                    {{ dt.description }}
                                </span>
                            </div>
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <span v-if="report.report_type" class="text-xs text-slate-500 dark:text-slate-400 truncate block mt-1">
                                    {{ report.report_type }}
                                </span>
                            </div>
                            <svg class="w-4 h-4 text-slate-400 opacity-0 group-hover:opacity-100 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
async function navigateToDoctype(doctypeName: string) {
    ...
    if (isSingle) {
        router.push({ name: 'EditForm', params: { app: appName, doctype: doctypeName, name: doctypeName } })
    } else {
