...
import type { DeskDocument, DocTypeMetadata, LocalsStore, DocumentInfo, ModelDocInfo } from "../../types/locals";
...
export const useLocalsStore = defineStore("locals", () => {
	 ...
	 */
	const setDocInfoField = (doctype: string, name: string, key: string, value: any) => {
		if (!docinfo.value[doctype]) {
			docinfo.value[doctype] = {};
		}
