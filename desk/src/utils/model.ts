 ...
 */
export async function fetchDocFromServer(doctype: string, name: string): Promise<DeskDocument | null> {
	try {
 ...
 */
export function getValue(doctype: string, filters: string | any, fieldname?: string, _callback?: any): any {
 ...
 */
export function setValue(doctype: string, name: string, fieldname: string, value: any) {
