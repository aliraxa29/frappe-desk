...
export interface DeskDom {
    ...
    add(parent: HTMLElement | string | null, tag: string, className?: string, css?: CSSStyles, html?: string, onclick?: (e: MouseEvent) => void): HTMLElement
    ...
    load_image(src: string, onload: (img: HTMLImageElement) => void, onerror?: () => void, preprocess?: (img: HTMLImageElement) => void): void
